...
month=now.month
"""
    Connection with the mysql database. This database contains the table where
    attendance if marked as per the location in the premise. 
"""
...
if __name__== "__main__":
    ...
    # for accessing mobile phones camera
